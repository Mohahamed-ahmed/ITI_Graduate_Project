...
export default function PackageCard({ show = false }) {
  return (
    <div className="rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition w-[350px] bg-card">
      <Image
        src={img}
        alt="Cairo"
      ...
      <div className="p-4">
        ...
        <p className="text-muted-foreground mb-4 ">Serengeti, Tanzania</p>
      </div>
      <div className="flex items-center justify-between p-2">
        ...
        <p className="px-4 py-2 text-primary">$2,500</p>
      </div>
      <div>
        <p className="text-muted-foreground mb-4 p-4">
          Experience the thrill of a lifetime with our Safari Experience package, exploring the wilds of Tanzania.
        </p>
      </div>
      {show && (
        <div className="flex w-full justify-between">
          <Link
            href="/dashboard/packs/edit-package/1"
