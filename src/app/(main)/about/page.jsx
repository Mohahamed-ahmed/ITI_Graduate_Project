          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-card rounded-lg p-8 shadow-md mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed mb-6">
                ...
                unforgettable memories and connecting with cultures that have shaped human civilization. Our mission is
                to provide authentic, curated travel experiences that showcase the best of Egypt.
              </p>
            </div>
